...
This is third and final part of the three-part series covering these topics. 
...
In the first part of this series we dealt with state in functional programming and its relevance to Cardano's eutxo model, while in the second part we set up the correspondence of formal specification of methods via pre and postconditions with (on-chain) validators for the corresponding redeemers. 
...
Lastly, we have to build transaction bodies out of the skeletons, sign and submit. Here are the essential details (for the full-fledged version see [@brujnes2023vestingApp])
